...
class CategoryHomeCard extends StatefulWidget {
  ...
  CategoryHomeCard({Key key, this.topMenu}) : super(key: key);
...
class _CategoryHomeCardState extends State<CategoryHomeCard> {
  void translate() async {
    ...
    translator.translate(widget.topMenu.menuTitle, to: 'ml').then((result) {
      setState(() {
        if (preferences.getString('language') == 'malayalam') {
          widget.topMenu.menuTitle = result.text;
        } else {}
      });
    });
  }
